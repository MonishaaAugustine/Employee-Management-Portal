...
<script>
  jQuery(function() {
    jQuery( "#project_assign_date" ).datepicker({
      changeMonth: true,
      changeYear: true,
       yearRange: "-5:+1",
       dateFormat: 'd MM,yy'
      ...
      <h2>Project Assignment Form</h2>
        <form action="model/salary.jsp" method="post">
          ...
          <div>
            ...
            <input type="text" name="project_assign_date" id="project_assign_date" value="<% out.print(Values.get("sal_amount")); %>" size="22" style="width:300px;">
          </div>
          <div class="block clear"></div>
          <div>
            <input name="submit" type="submit" value="Save Resource">
            &nbsp;
