...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
      <!-- main body --> 
      <div id="comments" style="width: 70%; float:right; margin-`right:30px">
      <h2>Contact Us Form</h2>
        ...
        <div style="float: left">
        	<div><img src="images/demo/slider/img_4.png" style="width: 250px; height:250px"></div><br>
        	<div><img src="images/demo/bulb.png" style="width: 250px; height:250px"></div>
        </div>
      <div class="clear"></div>
    </main>
  </div>
