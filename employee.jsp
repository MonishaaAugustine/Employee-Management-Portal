  ...
  <div class="rounded">
    <main class="container clear"> 
	  ...
	  <div class="one_third">
            ...
            <select style="height: 40px; width:200px" name= "employee_status" id = "employee_status">
			<% out.print(employeeDetails.getStatusOption((Integer) Values.get("employee_status"))); %>
			</select>
          </div>
	  <div class="one_third">
            <label for="email">Department<span>*</span></label>
            <select style="height: 40px; width:200px" name = "employee_deparment" id = "employee_deparment">
		<% out.print(employeeDetails.getDepartmentOption((Integer) Values.get("employee_deparment"))); %>
          ...
          <div class="one_third first">
            ...
            <input type="text" name="employee_first_name" id="employee_first_name" value="<% out.print(Values.get("employee_first_name")); %>" size="22">
          </div>
          <div class="one_third">
            <label for="email">Middle Name <span>*</span></label>
            <input type="text" name="employee_middle_name" id="employee_middle_name" value="<% out.print(Values.get("employee_middle_name")); %>" size="22">
          </div>
          <div class="one_third">
            <label for="url">Last Name</label>
            <input type="text" name="employee_last_name" id="employee_last_name" value="<% out.print(Values.get("employee_last_name")); %>" size="22">
          </div>
          <div  class="one_third first">
	  ...
	  <div class="one_third">
			...
			<input type="text" name="employee_dob" id="employee_dob" value="<% out.print(Values.get("employee_dob")); %>" size="22" readonly>
          </div>
          <div class="one_third">
            <label for="url">Nationality</label>
            <input type="text" name="employee_nationalty" id="employee_nationalty" value="<% out.print(Values.get("employee_nationalty")); %>" size="22">
          </div>
          
	  <div class="one_third first">
            <label for="url">E-mail</label>
            <input type="text" name="employee_email" id="employee_email" value="<% out.print(Values.get("employee_email")); %>" size="22">
          </div>
	  <div class="one_third">
            <label for="url">Landline</label>
            <input type="text" name="employee_landline" id="employee_landline" value="<% out.print(Values.get("employee_landline")); %>" size="22">
          </div>
          <div class="one_third">
            <label for="url">Mobile</label>
            <input type="text" name="employee_mobile" id="employee_mobile" value="<% out.print(Values.get("employee_mobile")); %>" size="22">
          </div>
	  ...
	  <div style="clear:both"></div>
          ...
          <div class="one_third first">
            ...
            <input type="text" name="employee_address" id="employee_address" value="<% out.print(Values.get("employee_address")); %>" size="22">
          </div>
          <div class="one_third">
            <label for="url">Village/City/Town</label>
            <input type="text" name="employee_village" id="employee_village" value="<% out.print(Values.get("employee_village")); %>" size="22">	
          </div>
          <div class="one_third">
          ...
          <div class="one_third">
            ...
            <input type="text" name="employee_password" id="employee_password" value="" size="22">
          </div>
          
          <div class="one_third ">
            <label for="url">Confirm Password</label>
            <input type="text" name="employee_confirm_password" id="employee_confirm_password" value="" size="22">
          </div>
		  <% } %>
          <div class="block clear"></div>
          <div>
        ...
        <div style="float: left">
        	<div><img src="images/demo/slider/img_2.png" style="width: 250px ;height:250px"></div><br>
        	<div><img src="images/demo/slider/img_3.png" style="width: 250px ;height:250px"></div><br>
